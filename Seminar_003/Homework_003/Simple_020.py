...
if isCyrillic(text):
	print(f' Ваша сумма очков = {sum([k for i in text for k, v in points_ru.items() if i in v])}')
else:
	print(f' Your score = {sum([k for i in text for k, v in points_en.items() if i in v])}')