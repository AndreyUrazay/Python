...
# начиная с 1 (при этом иногда вагоны нумеруются 
...
# что его вагон имеет номер j. Он хочет определить, сколько 
# всего вагонов в электричке. Напишите программу, которая будет 
# это делать или сообщать, что без дополнительной информации это сделать невозможно.
# Input: 3 4(ввод на разных строках)
# Output: 6

i = int(input ("Введите номер вагона в который сели: "))
j = int (input ("Введите номер вагона по счету: "))
if i == j:
